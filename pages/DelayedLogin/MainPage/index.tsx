...
import { PageItem, CitrixHeader } from "../../../Data/citrixData";
...
const MainPage: NextPage = () => {
  ...
  const pageInformation =
    "In this page, search for your app and click on them. After 5s if the app does not open, click again!";
  const [loading, setLoading] = useState(false);

  const doSearch = useCallback(() => {
    setPageItem(
      PageItem.filter((item) =>
      ...
      <Box height="100vh" width="100vw" overflow="none visible">
        ...
        >
          <Typography variant="h5">
            Prototype <strong>StoreFront</strong>
          </Typography>
